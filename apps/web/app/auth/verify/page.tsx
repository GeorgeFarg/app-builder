...
>
  ...
  {/* Verify Email Card */}
  <div className="relative z-10 w-full max-w-md p-10 space-y-5 bg-slate-800/50 backdrop-blur-md rounded-2xl shadow-2xl">
    ...
    <form onSubmit={handleVerify} className="space-y-5">
      ...
      <button
        ...
        className={`w-full border border-pink-600 text-pink-600 font-medium py-2.5 rounded-lg transition-all hover:bg-pink-700/10 cursor-pointer ${resendTimer > 0 ? "opacity-60 cursor-not-allowed" : ""}`}
      >
