...
const editorReducer = (state: EditorState = initialState, action: EditorAction): EditorState => {
    switch (action.type) {
        case 'ADD_ELEMENT':
            const updatedEditorState: EditorState['editor'] = {
                ...state.editor,
            ...
            if (state.history.currentIndex < state.history.history.length - 1) {
                ...
                const redoState: EditorState = {
                    ...
                    editor: {
                        ...state.editor,
                        ...nextEditorState,
                        // Ensure liveMode is always boolean, not undefined
                        liveMode: nextEditorState.liveMode !== undefined ? nextEditorState.liveMode : false,
                    },
                    history: {
                        ...state.history,
            ...
            if (state.history.currentIndex > 0) {
                ...
                const undoState: EditorState = {
                    ...
                    editor: {
                        ...
                        ...prevEditorState,
                        // Ensure liveMode is always boolean, not undefined
                        liveMode: prevEditorState.liveMode !== undefined ? prevEditorState.liveMode : false,
                    },
                    history: {
                        ...state.history,
